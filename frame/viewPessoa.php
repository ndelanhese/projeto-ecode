  ...
  <div class="container-fluid">
    <div class="p-4 mt-1 p-md-5 mb-4 text-white rounded bg-dark">
      <div class="col-md-6 px-0">
        <h2 class="display-10 fst-italic">Visualizar - Pessoa</h2>
      </div>
    </div>
    <form method="POST" class="row g-3" id="app3">
      <div class="col-md-6">
        <label for="email" class="form-label">Email:</label>
        <input type="email" name="email" class="form-control" id="email" value="<?php echo $email ?>" placeholder="Ex: email@email.com" disabled>
      </div>
      <div class="col-md-6">
        <label for="senha" class="form-label">Senha:</label>
        <input type="password" class="form-control" name="senha" id="senha" value="<?php echo $email ?>" placeholder="Ex: Senha" disabled>
      </div>

      <div class="col-md-6">
        <label for="nome" class="form-label">Nome Completo:</label>
        <input type="text" id="nome" name="nome" class="form-control" name="nome" value="<?php echo $nomeC ?>" placeholder="Ex: Pedro José" aria-label="First name" disabled>

      </div>
      <div class="col-md-3">
        <label for="cpf" class="form-label">CPF:</label>
        <input type="text" class="form-control" maxlength="11" oninput="criaMascara('CPF')" name="cpf" id="CPFInput" placeholder="Ex: 123.456.789-10" value="<?php echo $cpf ?>" name="cpf" disabled>
      </div>
      <div class="col-md-3">
        <label for="rg" class="form-label">RG:</label>
        <input type="text" class="form-control" id="rg" placeholder="Ex: 12.345.678-9" name="rg" maxlength="12" value="<?php echo $rg ?>" disabled>
      </div>

      <div class="col-md-3">
        <label for="nascimento" class="form-label">Data de Nascimento:</label>
        <input type="date" class="form-control" id="nascimento" name="nascimento" placeholder="" value="<?php echo $nascimento ?>" disabled>
      </div>
      <div class="col-md-3">
        <label for="sexo" class="form-label">Sexo:</label>
        <select id="sexo" class="form-select" name="sexo" disabled>
      ...
      <div class="col-md-3">
        ...
        <input type="text" class="form-control" id="CelularInput" maxlength="11" oninput="criaMascara('Celular')" name="celular" value="<?php echo $celular ?>" placeholder="Ex: (12) 9 1234-5678" disabled>
      </div>
      <div class="col-md-3">
        <label for="telefone" class="form-label">Telefone:</label>
        <input type="text" class="form-control" id="TelefoneInput" maxlength="10" oninput="criaMascara('Telefone')" name="telefone" value="<?php echo $telefone ?>" placeholder="Ex: (12) 1234-5678" disabled>
      </div>

      <div class="col-md-6">
        <label for="endereco" class="form-label">Endereço:</label>
        <input type="text" class="form-control" id="endereco" name="endereco" value="<?php echo $endereco ?>" placeholder="Ex: Rua tal" disabled>
      </div>
      <div class="col-md-3">
        <label for="numero" class="form-label">Número:</label>
        <input type="text" class="form-control" id="numero" name="numero" value="<?php echo $numero ?>" placeholder="Ex: 123A" disabled>
      </div>
      <div class="col-md-3">
        <label for="bairro" class="form-label">Bairro:</label>
        <input type="text" class="form-control" id="bairro" name="bairro" value="<?php echo $bairro ?>" placeholder="Ex: Centro" disabled>
      </div>


      <div class="col-md-3">
        <label for="complemento" class="form-label">Complemento:</label>
        <input type="text" class="form-control" id="complemento" name="complemento" value="<?php echo $complemento ?>" placeholder="Ex: Casa Marrom" disabled>
      </div>
      <div class="col-md-3">
        <label for="cep" class="form-label">CEP</label>
        <input type="text" class="form-control" id="CEPInput" maxlength="8" oninput="criaMascara('CEP')" name="cep" value="<?php echo $cep ?>" placeholder="Ex: 81560-000" disabled>
      </div>
      ...
      <div class="col-md-3">
        ...
        <select id="cidades" name="cidades" class="form-select" disabled>

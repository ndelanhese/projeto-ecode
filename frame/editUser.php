    ...
    <div class="container-fluid " id="app4">
        ...
        <div class="p-4 mt-1 p-md-5 mb-2 text-white rounded bg-dark">
            <div class="col-md-6 px-0">
                <h2 class="display-10 fst-italic">Editar - Usuário</h2>
            </div>
        </div>
        ...
        <div class="container">
            ...
            <form method="POST" class="row g-3" id="app3">
                <div class="col-md-6">
                    ...
                    <input type="email" name="email" value="<?php echo $email ?>" class="form-control" id="email" placeholder="Ex: email@email.com" required>
                </div>
                <div class="col-md-6">
                ...
                <div class="col-md-6">
                    ...
                    <input type="text" id="nome" name="nome" class="form-control" value="<?php echo $nomeC ?>" placeholder="Ex: Pedro José" aria-label="First name" required>

                </div>
                <div class="col-md-3">
                    <label for="adm" class="form-label">Nível:</label>
                    <select id="adm" name="adm" class="form-select">
                ...
                <div class="col-md-3">
                    ...
                    <div class="col-auto">
                        ...
                        <select name="situacao" class="form-select" id="situacao" value="<?php echo $status ?>">
